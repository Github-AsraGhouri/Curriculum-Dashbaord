        ...
        <div className="Header">
          <Navbar color="white" expand="md" light>
            ...
            <Nav className="main-menu" navbar>
                <NavItem>
                  <NavLink href="/components/">Meus Curriculos</NavLink>
                </NavItem>
                <NavItem>
                  <NavLink href="/components/">Carta de Apresentacao</NavLink>
                </NavItem>
                <NavItem>
                  <NavLink href="/components/">Empregos</NavLink>
                </NavItem>
                <NavItem>
                  <NavLink href="/components/">Compartilhar</NavLink>
                </NavItem>
            </Nav>
